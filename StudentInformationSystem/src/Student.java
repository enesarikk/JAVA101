public class Student {
    ...
    void printNote(){
        System.out.println(c1.name + "Notu : " + this.c1.calculateAverage());
        System.out.println(c2.name + "Notu : " + this.c2.calculateAverage());
        System.out.println(c3.name + "Notu : " + this.c3.calculateAverage());
